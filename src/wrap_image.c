...
#define SWIG_init      luaopen_image
#define SWIG_init_user luaopen_image_user

#define SWIG_LUACODE   luaopen_image_luacode
...
static int _wrap_delete(lua_State* L) {
  ...
  SWIG_check_num_args("image_delete",1,1)
  if(!lua_isnumber(L,1)) SWIG_fail_arg("image_delete",1,"int");
  arg1 = (int)lua_tonumber(L, 1);
  image_delete(arg1);
...
static int _wrap_exists(lua_State* L) {
  ...
  SWIG_check_num_args("image_exists",1,1)
  if(!lua_isnumber(L,1)) SWIG_fail_arg("image_exists",1,"int");
  arg1 = (int)lua_tonumber(L, 1);
  result = (bool_t)image_exists(arg1);
...
static int _wrap_width(lua_State* L) {
  ...
  SWIG_check_num_args("image_width",1,1)
  if(!lua_isnumber(L,1)) SWIG_fail_arg("image_width",1,"int");
  arg1 = (int)lua_tonumber(L, 1);
  result = (int)image_width(arg1);
  lua_pushnumber(L, (lua_Number) result); SWIG_arg++;
  return SWIG_arg;
...
static int _wrap_height(lua_State* L) {
  ...
  SWIG_check_num_args("image_height",1,1)
  if(!lua_isnumber(L,1)) SWIG_fail_arg("image_height",1,"int");
  arg1 = (int)lua_tonumber(L, 1);
  result = (int)image_height(arg1);
  lua_pushnumber(L, (lua_Number) result); SWIG_arg++;
  return SWIG_arg;
